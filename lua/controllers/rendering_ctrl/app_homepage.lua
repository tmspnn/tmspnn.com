...
local function get_latest_followings(uid)
    if uid == nil then return cjson.empty_array end
    ...
    if empty(following_ids) then return cjson.empty_array end
...
local function get_latest_feeds(uid)
    ...
    if empty(feed_ids) then return cjson.empty_array end
